...
def main():
	...
	img =  cv2.imread('../../display images/blue_facetracker.png')
	cv2.namedWindow("Interactive Display")
	...
	while 1:
		...
		if stringData == "1":
			img =  cv2.imread('../../display images/green_facetracker.png')
			cv2.imshow("Interactive Display",img)
			cv2.waitKey(3000)
			stringData = "2" 
			
		elif stringData == "2":
			img =  cv2.imread('../../display images/yellow_facetracker.png')
			cv2.imshow("Interactive Display",img)
			cv2.waitKey(3000)
			stringData = "2"
		elif stringData == "3":
			img =  cv2.imread('../../display images/red_facetracker.png')
			cv2.imshow("Interactive Display",img)
			cv2.waitKey(3000)
			stringData = "2"

		elif stringData == "4":
			img =  cv2.imread('../../display images/yellow_facetracker2.png')
			cv2.imshow("Interactive Display",img)
			cv2.waitKey(3000)
			stringData = "2"
